...
for (i in c(4,7,12,14,20,22,35,40,41,46,50)){
...
# 
metascore_data = metascore_data[-c(51,52)]
# #Data-Preprocessing: converting metascore to numerical
metascore_data<-as.double(metascore_data)
# 
...
gross_data<-as.double(gross_data)
...
movies_df<-data.frame(Rank = rank_data, Title = title_data,
                      ...
                      Genre = genre_data, Rating = rating_data, Duration = runtime_data,
                      Director = directors_data, Actor = actors_data, Gross = gross_data,
                      Votes = votes_data, MetaScore = metascore_data)
